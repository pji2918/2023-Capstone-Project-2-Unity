    ...
    public class UIManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showSplashScreen)
            {
                ...
                showSplashScreenOnce.boolValue = ReachEditorHandler.DrawToggle(showSplashScreenOnce.boolValue, customSkin, "Show Only Once", "Only appears in the current session when enabled.");
